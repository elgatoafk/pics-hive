...
Revision ID: 7b10b35ceafc
Revises: f8c56202ac3a
Create Date: 2024-07-31 07:12:46.639845
...
revision: str = '7b10b35ceafc'
down_revision: Union[str, None] = 'f8c56202ac3a'
...
def downgrade() -> None:
    ...
    sa.Column('1', sa.INTEGER(), autoincrement=False, nullable=True),
    sa.Column('test', sa.VARCHAR(length=50), autoincrement=False, nullable=True),
